export const getCardEditMarkup = ({color, repeatingDays, description, dueDate, tags}) => `<article class="card card--edit card--${color} ${Object.values(repeatingDays).includes(true) ? `card--repeat` : ``}">
  <form class="card__form" method="get">
    ...
    minute: `2-digit`,
            ...
            <button class="card__repeat-toggle" type="button">
              repeat:<span class="card__repeat-status">${Object.values(repeatingDays).includes(true) ? `yes` : `no`}</span>
            </button>
